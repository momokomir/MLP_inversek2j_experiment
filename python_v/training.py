...
NET_NUM = 5
SAMPLE_NUM = 5  # the number of samples
DELTA = 1.5*0.00304446085
...
def cac_weight(weight_vector, i):
    ...
    # save a parameter
    tt[i] = sum(hs_func()(DELTA - error_vector_tmp)) * alpha
